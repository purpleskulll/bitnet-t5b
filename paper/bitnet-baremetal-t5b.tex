...
rate and clock the loop sustains \num{2.45} vector operations per cycle against
the baseline's \num{2.32} --- both above the two per cycle that a part cracking
...
\SIrange{6}{11}{\percent} band. No file records that \num{19.7}: the figure
implied by this paper's own two constants, \num{33.74}\,GMAC/s at
\SI{3.91}{\giga\hertz}, is $160\times\num{3.91}/\num{33.74}=\num{18.54}$
