...
lives entirely inside it. Hariri et al.~\cite{kvkeys} act on that half rather
...
Hariri et al.~\cite{kvkeys} act on exactly that half. They show the key
...
\bibitem{kvkeys} M.~Hariri, A.~Luo, W.~Chen, T.~Zhang, Q.~Wang, X.~Han,
