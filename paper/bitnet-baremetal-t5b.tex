...
\item A decode of depth one rather than depth five (\S\ref{sec:kernel}). That a
      ...
      What is left, and what \S\ref{sec:kernel} actually claims, is what happens
      \emph{after} the extraction. NTRU materialises every coefficient into a
      ...
      \code{vpmaddubsw} contraction, so that no weight is ever materialised in a
      ...
      form and buys latency; \S\ref{sec:condition} gives the condition under
