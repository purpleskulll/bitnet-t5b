...
\SI{45.7}{\milli\second}, and the replay of \S\ref{sec:traffic} puts a token's
\code{i2\_s} matmuls at about \SI{14}{\milli\second}. Weight streaming is
therefore roughly \SI{30}{\percent} of a token; the rest is attention, the KV
...
uses \SI{11.4}{\giga\byte\per\second} of the \num{38.9} this machine delivers: it
is not at the memory wall.
...
\paragraph{The port analysis is Zen 2 specific before VNNI even enters.}
