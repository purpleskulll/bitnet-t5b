...
in heuristic search~\cite{breyerkorf}; recovering all five digits
...
al.~\cite{zukowski}, twenty years old. \S\ref{sec:contrib} states each
...
$S=\num{2.43}$ lies \emph{inside} the interval it spans. At \num{3.03} the
denser format wins at six threads; at \num{1.75} it does not. The sign of the
...
(\code{results/sigma\_six\_threads.txt}). For t5b, $S=\num{2.43}$ measured against $F=\num{1.25}$;
