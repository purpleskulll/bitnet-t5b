...
verbatim; the integration is applied as a patch to an unmodified
\code{llama.cpp} checkout. Every figure is recomputed by a script there and
recorded under \code{results/}, each file stating its own reproduction command: \code{tensor\_structure.txt} and \code{real\_weights\_check.txt} (code
